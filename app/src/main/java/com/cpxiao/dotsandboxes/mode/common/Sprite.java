package com.cpxiao.dotsandboxes.mode.common;
...
public class Sprite {
    ...
    private RectF mCollideRectF = new RectF();//碰撞体
    ...
    public void setCollideRectF(float left, float top, float right, float bottom) {
        mCollideRectF.set(left, top, right, bottom);
    }
